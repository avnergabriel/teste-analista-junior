...
<html class="ls-theme-green">
  <head>
    <title>Happy Code - Petrolina</title>

    <meta charset="utf-8">
    <meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
    <meta name="description" content="Happy Code -  Petrolina.">
  ...
  <!-- Nome do produto/marca com sidebar -->
    <h1 class="ls-brand-name">
      <a href="home" class="ls-ico-home">
        <small>Happy Code - Petrolina</small>
        Happy Code
      </a>
    </h1>
  ...
  <div class="ls-sidebar-inner">
      ...
      <nav class="ls-menu">
        <ul>
           ...
           <li><a href="{{(url('/prematricula'))}}" class="ls-ico-edit-admin" title="Pré-Matrícula">Pré-Matrícula</a></li>
           <li>
